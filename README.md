...
- [AWS GuardDuty \& Security Hub CSPM Integration](#aws-guardduty--security-hub-cspm-integration)
  ...
  - [📋 Common Configuration \& Logging](#-common-configuration--logging)
  - [⚖️ License](#️-license)
...
**The Solution:** This repository provides automation to ensure that finding states are synchronized. When a GuardDuty finding is archived—either manually or automatically—it is immediately resolved in Security Hub.
